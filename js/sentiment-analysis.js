...
const twitterapical =
  "https://github.com/shashank153/sentiment-analysiso-frontend.git";
...
function displayPieChart(twitterData) {
  ...
  var chart = new CanvasJS.Chart("chartContainer", {
    ...
    data: [{
      ...
      dataPoints: [{
          y: (
            (sentimentsCounter["Positive"] * 100.0) /
            twitterData.length
          ).toFixed(2),
          label: "Positive",
        },
        {
          y: (
            (sentimentsCounter["Neutral"] * 100.0) /
            twitterData.length
          ).toFixed(2),
          label: "Neutral",
        },
        {
          y: (
            (sentimentsCounter["Negative"] * 100.0) /
            twitterData.length
          ).toFixed(2),
          label: "Negative",
        },
